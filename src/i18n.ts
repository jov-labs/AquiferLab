...
const translations = {
  es: {
    ...
    scenarioWellAX: "Pozo A X",
    scenarioWellAY: "Pozo A Y",
    scenarioWellBRate: "Q pozo B",
    scenarioWellBX: "Pozo B X",
    scenarioWellBY: "Pozo B Y",
  ...
  en: {
    ...
    scenarioWellAX: "Well A X",
    scenarioWellAY: "Well A Y",
    scenarioWellBRate: "Q well B",
    scenarioWellBX: "Well B X",
    scenarioWellBY: "Well B Y",
