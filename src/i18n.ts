...
const translations = {
  es: {
    ...
    exportHydroModel: "Exportar modelo",
    hydroModelExportFailed: "No se pudo exportar el modelo hidrogeológico.",
    ...
    pumpingA: "¿Cuánta agua extrae el pozo A? (Q)",
    pumpingB: "¿Cuánta agua extrae el pozo B? (Q)",
    ...
    scenarioComparatorTitle: "Comparador de escenarios",
    activeScenario: "● Activo",
    useScenario: "○ Usar",
    scenarioHydraulicReference: "Referencia hidráulica",
    scenarioHydraulicReferenceLines: ["Referencia", "hidráulica"],
    scenarioReferenceHead: "Carga de referencia",
    scenarioReferenceHeadLines: ["Carga de", "referencia"],
    scenarioRegional: "Regional",
    scenarioRegionalReferenceSide: "Referencia hidráulica regional",
    scenarioRegionalReferenceSideLines: ["Referencia", "hidráulica", "regional"],
    regionalReferenceWest: "Oeste",
    regionalReferenceEast: "Este",
    regionalReferenceNorth: "Norte",
    regionalReferenceSouth: "Sur",
    noUnit: "—",
    parameter: "Parámetro",
    unit: "Unidad",
    scenarioName: "Nombre del escenario",
    addScenario: "+ Añadir escenario",
    removeScenario: "Eliminar",
    scenarioParameterK: "K",
    scenarioParameterThickness: "b",
    scenarioWellARate: "Q pozo A",
    scenarioWellAX: "X de pozo A",
    scenarioWellAY: "Y de pozo A",
    scenarioWellBRate: "Q pozo B",
    scenarioWellBX: "X de pozo B",
    scenarioWellBY: "Y de pozo B",
    scenarioWellDistance: "Distancia A–B",
    scenarioCoordinatesNote: "X/Y son coordenadas del dominio del modelo en metros; no necesariamente coordenadas UTM.",
    scenarioPositionOutsideDomain: "La posición debe estar dentro del dominio del modelo.",
    scenarioPositionOnFixedHead: "Un pozo no puede ocupar una celda de carga fija del río.",
    metersUnit: "m",
    metersPerSecondUnit: "m/s",
    litersPerSecondUnit: "l/s",
  ...
  en: {
    ...
    exportHydroModel: "Export model",
    hydroModelExportFailed: "The hydrogeological model could not be exported.",
    ...
    pumpingA: "How much water does well A extract? (Q)",
    pumpingB: "How much water does well B extract? (Q)",
    ...
    scenarioComparatorTitle: "Scenario comparator",
    activeScenario: "● Active",
    useScenario: "○ Use",
    scenarioHydraulicReference: "Hydraulic reference",
    scenarioHydraulicReferenceLines: ["Hydraulic", "reference"],
    scenarioReferenceHead: "Reference head",
    scenarioReferenceHeadLines: ["Reference", "head"],
    scenarioRegional: "Regional",
    scenarioRegionalReferenceSide: "Regional hydraulic reference",
    scenarioRegionalReferenceSideLines: ["Regional", "hydraulic", "reference"],
    regionalReferenceWest: "West",
    regionalReferenceEast: "East",
    regionalReferenceNorth: "North",
    regionalReferenceSouth: "South",
    noUnit: "—",
    parameter: "Parameter",
    unit: "Unit",
    ...
    scenarioParameterK: "K",
    scenarioParameterThickness: "b",
    scenarioWellARate: "Q well A",
    scenarioWellAX: "X of well A",
    scenarioWellAY: "Y of well A",
    scenarioWellBRate: "Q well B",
    scenarioWellBX: "X of well B",
    scenarioWellBY: "Y of well B",
    scenarioWellDistance: "Distance A–B",
    scenarioCoordinatesNote: "X/Y are model-domain coordinates in metres; they are not necessarily UTM coordinates.",
    scenarioPositionOutsideDomain: "The position must be inside the model domain.",
    scenarioPositionOnFixedHead: "A well cannot occupy a fixed-head river cell.",
    metersUnit: "m",
    metersPerSecondUnit: "m/s",
    litersPerSecondUnit: "l/s",
